...
#define LCD_SPI_ST7565_ERC12864 78 //128X64
...
typedef  enum typelcmd {lstop,lplay,lmeta,licy0,licy4,lnameset,lvol,lovol,estation,eclrs,edraw,etoggle,escreen,erefresh,eusblist} typelcmd;
typedef struct {
